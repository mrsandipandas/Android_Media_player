...
/**
 * \brief   View for displaying NexPlayer&trade; video output when using 
 *          the OpenGL renderer.
 *
 * For details see the <i>OpenGL Renderer</i> section of the
 * general {@link com.nextreaming.nexplayerengine} documentation.
 */
public class GLRenderer extends GLSurfaceView{
    ...
    /**
     * \brief   Causes the next rendering pass to clear the video image.
     *
     ...
     * next rendering pass, this is automatically reset to \false.
     *
     ...
     *
     * \param   np          The \c NexPlayer object that will provide the video frames
